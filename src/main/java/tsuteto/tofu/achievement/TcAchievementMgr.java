...
public class TcAchievementMgr
{
    public static enum Key
    {
        ...
        hiyayakko(40), nikujaga(41), yakionigiriShoyu(42), yakionigiriMiso(43), nattoMaking(44), nattoFerm(45), natto(46), nattoRice(47), tofuMining(48), koyaStew(49),
