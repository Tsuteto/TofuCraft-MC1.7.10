...
public class TcAchievements
{
    public static void load()
    {
        ...
        // === Tofu World ===
        TcAchievement.create(Key.tofuGem, 8, 4, ItemTcMaterials.tofuGem.getStack(), null)
