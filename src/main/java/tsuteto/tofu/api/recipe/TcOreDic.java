...
//    logApricot(new ItemStack(TcBlock.tcLog, 1, 0)),
    ...
    rollingPin(new ItemStack(TcItems.materials, 1, ItemTcMaterials.rollingPin.id)),
    tofuSomen(new ItemStack(TcItems.materials, 1, ItemTcMaterials.tofuSomen.id)),
    glassBowl(new ItemStack(TcItems.materials, 1, ItemTcMaterials.glassBowl.id)),
    somenTsuyuBowl(TcItems.somenTsuyuBowl),

    tfCapacitor(new ItemStack(TcItems.materials, 1, ItemTcMaterials.tfCapacitor.id)),
    tfCoil(new ItemStack(TcItems.materials, 1, ItemTcMaterials.tfCoil.id)),
    tfOscillator(new ItemStack(TcItems.materials, 1, ItemTcMaterials.tfOscillator.id)),
    tfCircuitBoard(new ItemStack(TcItems.materials, 1, ItemTcMaterials.tfCircuit.id)),
    advTofuGem(new ItemStack(TcItems.materials, 1, ItemTcMaterials.advTofuGem.id)),
    activatedTofuGem(new ItemStack(TcItems.materials, 1, ItemTcMaterials.activatedTofuGem.id)),
    activatedHellTofu(new ItemStack(TcItems.materials, 1, ItemTcMaterials.activatedHellTofu.id)),
    ;
